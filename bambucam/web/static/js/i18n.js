...
(function () {
  ...
  const translations = {
    en: {
      ...
      "systemReboot.section": "System",
      "systemReboot.action": "Restart Raspberry Pi",
      "systemReboot.confirm": "Restart the entire Raspberry Pi now? Camera and all streams will be unavailable during startup.",
      "systemReboot.scheduling": "Scheduling reboot…",
      "systemReboot.started": "Raspberry Pi is restarting…",
      "systemReboot.failed": "Raspberry Pi restart failed: {message}",
      "systemReboot.hint": "Restarts the operating system, not just BambuCam.",
      ...
      "profile.customDescription": "Manual settings are active. Applying a profile replaces resolution, frame rate, JPEG quality, RTSP bitrate, and the image controls defined by that profile.",
    ...
    de: {
      ...
      "systemReboot.section": "System",
      "systemReboot.action": "Raspberry Pi neu starten",
      "systemReboot.confirm": "Jetzt den gesamten Raspberry Pi neu starten? Kamera und alle Streams sind während des Hochfahrens nicht verfügbar.",
      "systemReboot.scheduling": "Neustart wird vorbereitet…",
      "systemReboot.started": "Raspberry Pi wird neu gestartet…",
      "systemReboot.failed": "Raspberry-Pi-Neustart fehlgeschlagen: {message}",
      "systemReboot.hint": "Startet das Betriebssystem neu, nicht nur BambuCam.",
      "footer.description": "BambuCam — Open Source Raspberry Pi Camera Streaming",
      ...
      "profile.customDescription": "Manuelle Einstellungen sind aktiv. Das Anwenden eines Profils ersetzt Auflösung, Framerate, JPEG-Qualität, RTSP-Bitrate und die im Profil definierten Bildregler.",
